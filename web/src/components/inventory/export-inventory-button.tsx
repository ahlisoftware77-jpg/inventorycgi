...
export default function ExportInventoryButton({ items, itemType }: ExportInventoryButtonProps) {
  ...
  return (
    <Button 
        ...
        className="h-12 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase text-[10px] tracking-widest shadow-[0_5px_0_0_rgba(5,150,105,0.3)] active:translate-y-[2px] active:shadow-none transition-all"
    >

      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[state=collapsed]:hover:border-r group-data-[state=collapsed]:hover:border-border",
            className
          )}
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-card group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-border group-data-[variant=floating]:shadow-md group-data-[variant=floating]:shadow-purple-200/50 dark:group-data-[variant=floating]:shadow-purple-900/20"
          >
            {children}
          </div>
        </div>
...
>(({ className, ...props }, ref) => {
  ...
  // Use either openMobile or open based on current context
  const isChecked = isMobile ? openMobile : open

  return (
    <label className={cn("hamburger", className)} ref={ref} {...props}>
      <input 
        type="checkbox" 
        checked={isChecked}
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-foreground/70 outline-none ring-ring transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0",
        "group-data-[state=collapsed]:mt-0 group-data-[state=collapsed]:opacity-100",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:inline-flex",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-ring transition-all duration-200 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[state=open]:bg-accent group-data-[collapsible=icon]:!justify-center group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-accent hover:text-accent-foreground data-[active=true]:bg-primary/10 data-[active=true]:text-primary data-[active=true]:font-semibold",
        outline:
        ...
        uiverse: "h-auto p-3.5 gap-4 rounded-2xl font-bold transition-all duration-300 hover:bg-primary/5 hover:translate-x-1 active:scale-95 data-[active=true]:bg-primary data-[active=true]:text-primary-foreground data-[active=true]:shadow-lg data-[active=true]:shadow-primary/20 text-slate-600 dark:text-slate-400 [&>svg]:size-5",
      },
      size: {

...
/**
 * @fileOverview Formulir Tambah/Edit Software IT.
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
             ...
             <FormField control={form.control} name="notes" render={({ field }) => (
                <FormItem><FormLabel>Catatan</FormLabel><FormControl><Textarea placeholder="Catatan tambahan..." {...field} className={cn(inputClass, "h-auto")} /></FormControl><FormMessage /></FormItem>
            )} />
            <DialogFooter>

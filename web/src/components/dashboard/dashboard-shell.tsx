...
export default function DashboardShell({ children }: { children: ReactNode }) {
  ...
  const isStandalonePage = pathname.startsWith('/public/') || pathname.startsWith('/shared-warehouse') || pathname === '/login' || pathname === '/register' || pathname.startsWith('/form-app/preview') || pathname === '/download' || isSharedGallery;

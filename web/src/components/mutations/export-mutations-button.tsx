...
export default function ExportMutationsButton({ assets, activeTab, className }: ExportMutationsButtonProps) {
  ...
  return (
    <Button
      ...
      className={cn(
        "w-full sm:w-auto h-9 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-wider border-b-[3px] border-b-emerald-800 active:translate-y-[1px] active:border-b-[1px] border-none transition-all flex items-center justify-center disabled:opacity-50",
        className
      )}
    >

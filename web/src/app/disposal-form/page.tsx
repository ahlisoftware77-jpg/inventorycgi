...
export default function DisposalFormPage() {
    ...
    useEffect(() => {
        QRCode.toDataURL('CGI-DISPOSAL-SAMPLE', { margin: 1, width: 250 }).then(setQrCodeUrl);
    }, []);
            ...
            <table class="nested-table">
                ...
                <tr>
                    <td style="text-align: center; vertical-align: middle; height: 200px;">
                        ${qrCodeUrl ? `<img src="${qrCodeUrl}" style="width: 180px; height: 180px;" />` : '<div style="font-size:8px; color:#ccc;">QR CODE</div>'}

...
export default function PreviewFormsPage() {
    ...
    <div class="page">
      ...
      <table>
        ...
        <tr>
          <td rowspan="3">規格<br><br>Spec Barang</td> <td rowspan="3" colspan="3" class="input"></td>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colspan="4" rowspan="10" style="height: 30px; padding: 0;"> <table class="nested-table"> <tr><td style="text-align: center;">處理方式 Metode disposal:</td><td></td></tr> </table> </td>
          </tr>
          <tr>
    ...
    <style>
      ...
      .signature-table { margin-top: 10px; table-layout: fixed; }
    ...
    const handlePrint = (formHtml: string, width: number, height: number, orientation: 'portrait' | 'landscape' = 'portrait') => {
    ...
    const handlePrintAuditFix = async () => {
        ...
        try {
            ...
            const assets2025: Asset[] = [];
            querySnapshot.forEach((doc) => {
                const asset = { id: doc.id, ...doc.data() } as Asset;
                if (asset.code && asset.code.toUpperCase().startsWith('A') && asset.code.includes('2025')) {
                  assets2025.push(asset);
                }
            });
            ...
            if (assets2025.length === 0) {
                toast({
                    ...
                    description: 'Tidak ditemukan aset Seri A dengan "2025" pada kodenya.',
                });
                setIsLoading(false);
                return;
            }
            
            // Sort by costCenter (Area Code)
            assets2025.sort((a, b) => (a.costCenter || '').localeCompare(b.costCenter || ''));
            ...
            const totalQty = assets2025.reduce((sum, asset) => sum + (asset.qty || 0), 0);
            
            let tableRows = assets2025.map(asset => `
                <tr>
                    <td></td>
            ...
            const emptyRowCount = Math.max(0, 20 - assets2025.length);
            ...
            const filledForm = formAuditHtml
                ...
                .replace(
                    '<div style="border-bottom: 3px double #000; padding-bottom: 1px;">Fixed Asset</div>',
                    '<div style="border-bottom: 3px double #000; padding-bottom: 1px;">Fixed Asset : 2025</div>'
                )
                .replace(
                    '<td><!-- TOTAL_QTY --></td>',
                    ...
                    <Tabs defaultValue="asset">
                        ...
                        <TabsContent value="asset" className="mt-4">
                            <div className="flex justify-end mb-4">
                                <Button onClick={() => handlePrint(formAssetHtml, 815, 605)} variant="outline">
                        ...
                        <TabsContent value="disposal" className="mt-4">
                             <div className="flex justify-end mb-4">
                                <Button onClick={() => handlePrint(formDisposalHtml, 1123, 794)} variant="outline">
                                    <Printer className="mr-2 h-4 w-4" />
                                    Cetak Form Disposal
                                </Button>
                            </div>

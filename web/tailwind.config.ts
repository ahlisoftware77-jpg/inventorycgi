    ...
    extend: {
      ...
      colors: {
        amber: {
          ...
          500: '#eab308',
          600: '#ca8a04',
          700: '#a16207', // Yellower gold background
          800: '#854d0e',
          900: '#713f12',
          950: '#422006',
        },
      ...
      animation: {
        ...
        'bounce-text': 'bounce-text 5s ease-in-out infinite',
        'fade-in-out': 'fade-in-out 5s ease-in-out infinite',
        'slide-in-out': 'slide-in-out 6s ease-in-out infinite',
        'typewriter': 'typewriter 4s steps(40) infinite alternate',
        'text-gradient': 'text-gradient 5s ease alternate infinite',
